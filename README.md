...
## 2.2.0 Continue On Error

Focused patch:
- Preserves the working static-image upload behavior.
- Processes each ready record independently.
- Duplicate SKU no longer stops the whole batch.
- One failed record no longer blocks other records.
- Response now includes created / skipped / failed arrays.
