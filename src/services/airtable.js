...
export async function findReadyWarehouseReverbDrafts() {
  ...
  const readyForGuitarDraftField = process.env.AIRTABLE_READY_FOR_GUITAR_DRAFT_FIELD || "Ready for Guitar Draft";
  const readyForGearDraftField = process.env.AIRTABLE_READY_FOR_GEAR_DRAFT_FIELD || "Ready for Gear Draft";
